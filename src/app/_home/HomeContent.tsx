        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="animate-on-scroll">
            ...
            <div className="space-y-6 mb-10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Based in Thunder Bay, Ontario</p>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              We typically respond within 2&ndash;3 business days. Your information is never shared with any third parties.
            </p>
          </div>
...
export default function Home({ knowledgeHub }: { knowledgeHub?: React.ReactNode }) {
  ...
  return (
    <div ref={animationRef}>
      ...
      {/* Knowledge Hub — Blog & Insights Preview */}
      {knowledgeHub}
