...
const resources = [
  ...
  },
  {
    ...
    description:
      'An interactive spreadsheet that models expected revenue, costs, and net proceeds for a raffle program. Inputs tuned to realistic industry data.',
    length: 'Interactive Excel / Google Sheet',
    type: 'Tool',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    length: 'Notion / Google Sheets template',
    type: 'Template',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      'Our flagship industry research report. 32 pages covering market size, growth drivers, regulatory trends, and strategic implications.',
    length: '32-page report',
    type: 'Report',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {resources.map((r) => (
              ...
              >
                ...
                <Link
                  href={`/resources/request?title=${encodeURIComponent(r.title)}`}
