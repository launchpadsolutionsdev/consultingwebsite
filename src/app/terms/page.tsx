      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <div className="space-y-12">
            {/* Legal Disclaimer */}
            <div>
              <h2 className="text-2xl font-bold text-[#1B2A4A] mb-4">A Legal Disclaimer</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1B2A4A] mb-2">Terms and Conditions of Use</h2>
              <p className="text-[#415581] leading-relaxed mb-8">
              ...
              <h3 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">1. Eligibility</h3>
              <p className="text-[#415581] leading-relaxed">
                You must be at least 18 years old and legally capable of entering into binding contracts to use our services.
              </p>

              <h3 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">2. Use of Services</h3>
              <p className="text-[#415581] leading-relaxed">
              ...
              <h3 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">3. Intellectual Property</h3>
              <p className="text-[#415581] leading-relaxed">
              ...
              <h3 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">4. Limitation of Liability</h3>
              <p className="text-[#415581] leading-relaxed">
              ...
              <h3 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">5. Termination</h3>
              <p className="text-[#415581] leading-relaxed">
                We reserve the right to terminate or suspend access to our services for any reason, including breach of these terms.
              </p>

              <h3 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">6. Changes to Terms</h3>
              <p className="text-[#415581] leading-relaxed">
