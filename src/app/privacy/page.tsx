      ...
      <section className="py-16 lg:py-20 bg-[#F6F9FC]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-[#1B2A4A] mb-4">
              Privacy Policy
            </h1>
            <p className="text-[#6B7280] text-lg">Last updated: April 9, 2025</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <div className="space-y-12">
            {/* Privacy Policy */}
            <div>
              <p className="text-lg text-[#415581] leading-relaxed mb-8">
              ...
              <h2 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">1. Information We Collect</h2>
              <p className="text-[#415581] leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">2. Use of Information</h2>
              <p className="text-[#415581] leading-relaxed mb-3">We use collected data to:</p>
              <ul className="list-disc pl-6 text-[#415581] space-y-2">
              ...
              <h2 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">3. Donor Confidentiality</h2>
              <p className="text-[#415581] leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">4. Data Security</h2>
              <p className="text-[#415581] leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">5. Third-Party Services</h2>
              <p className="text-[#415581] leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">6. Your Rights</h2>
              <p className="text-[#415581] leading-relaxed">
                You may request to view, correct, or delete your personal information at any time by contacting us at{' '}
                <a href="mailto:info@launchpadsolutions.ca" className="text-[#FF6B2B] hover:underline">
                  info@launchpadsolutions.ca
                </a>
              </p>

              <h2 className="text-xl font-bold text-[#1B2A4A] mt-8 mb-3">7. Updates to This Policy</h2>
              <p className="text-[#415581] leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1B2A4A] mb-2">Accessibility Statement</h2>
              <p className="text-sm text-[#6B7280] mb-6">This statement was last updated on April 9, 2025.</p>

              <div className="space-y-5 text-[#415581] leading-relaxed">
                <p>
                ...
                <p>
                  ...
                  <a href="mailto:hello@launchpadsolutions.ca" className="text-[#FF6B2B] hover:underline">
                    hello@launchpadsolutions.ca
                  </a>{' '}
                  or{' '}
                  <a href="tel:+18076304698" className="text-[#FF6B2B] hover:underline">
                    1-807-630-4698
                  </a>
